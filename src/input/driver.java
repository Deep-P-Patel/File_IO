	...
	public static void openPrinter() {
		try {
			cartoonPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile/Cartoons_Comics.csv", true));
			hobbiesPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile/Hobbies_Collectibles.csv",
					true));
			moviesPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile/Movies_TV_Books.csv", true));
			musicPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile/Music_Radio_Books.csv", true));
			nostalgiaPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile/Nostalgia_Electronic_Books.csv",
					true));
			oldPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile/Old_Time_Radio_Books.csv",
					true));
			sportPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile/Sports_Memorabilia.csv", true));
			trainsPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile/Trains_Planes_Automobiles.csv",
					true));
			syntaxPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile/syntax_error_file.txt", true));
		} catch (Exception e) {
 ...
 */
	...
	public static void openObjectWriter() {
		try {
			cartoonsObjectPrinter = new ObjectOutputStream(new FileOutputStream(
					"C:\\Users\\formy\\Desktop\\Vasu Ass2\\GIT\\Assignment_3/Cartoons_Comics.csv.ser",
					true));
			hobbiesObjectPrinter = new ObjectOutputStream(new FileOutputStream(
					"C:\\Users\\formy\\Desktop\\Vasu Ass2\\GIT\\Assignment_3/Hobbies_Collectibles.csv.ser",
					true));
			moviesObjectPrinter = new ObjectOutputStream(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Movies_TV_Books.csv.ser",
					true));
			musicObjectPrinter = new ObjectOutputStream(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Music_Radio_Books.csv.ser",
					true));
			nostalgiaObjectPrinter = new ObjectOutputStream(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Nostalgia_Electronic_Books.csv.ser",
					true));
			oldObjectPrinter = new ObjectOutputStream(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Old_Time_Radio_Books.csv.ser",
					true));
			sportObjectPrinter = new ObjectOutputStream(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Sports_Memorabilia.csv.ser",
					true));
			trainsObjectPrinter = new ObjectOutputStream(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Trains_Planes_Automobiles.csv.ser",
					true));
			semanticPrinter = new PrintWriter(new FileOutputStream(
					"C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/semantic_error_file.txt",
					true));
		} catch (Exception e) {
	...
	public static void do_part1() {
		try {
			File directoryPath = new File("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/Files");
	...
	public static void do_part2() {
		try {
			File directoryPath = new File("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/src/InputFile");
...
//							System.out.println("Beginning of the file");
							currentPoint=-1;
							throw new Exception("Beginning of File");
						}
					}
				}
				else {
 ...
 */
		public static String selectFile()
		{
			...
			while(!exitSMenu) {
				...
				System.out.println("-----------------------------");
				System.out.println("1 Cartoons_Comics.csv.ser           ( "+getRecords("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Cartoons_Comics.csv.ser")+" records)");
				System.out.println("2 Hobbies_Collectibles.csv.ser      ( "+getRecords("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Hobbies_Collectibles.csv.ser")+" records)");
				System.out.println("3 Movies_TV.csv.ser                 ( "+getRecords("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Movies_TV_Books.csv.ser")+" records)");
				System.out.println("4 Music_Radio.csv.ser               ( "+getRecords("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Music_Radio_Books.csv.ser")+" records)");
				System.out.println("5 Nostalgia_Eclectic.csv.ser        ( "+getRecords("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Nostalgia_Electronic_Books.csv.ser")+" records)");
				System.out.println("6 Old_Time_Radio.csv.ser            ( "+getRecords("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Old_Time_Radio_Books.csv.ser")+" records)");
				System.out.println("7 Sports_Sports_Memorabilia.csv.ser ( "+getRecords("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Sports_Memorabilia.csv.ser")+" records)");
				System.out.println("8 Trains_Planes_Automobiles.csv.ser ( "+getRecords("C:/Users/formy/Desktop/Vasu Ass2/GIT/Assignment_3/Trains_Planes_Automobiles.csv.ser")+" records)");
